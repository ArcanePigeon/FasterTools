...
public class Config {
	private static final String CONFIG_FILE = "config/fastertools.json";
	private static Config instance = null;
	private final Logger LOGGER = FasterTools.LOGGER;
	...
	public int getToolSpeedModifier () {
		return configData.getInt("tool_speed_modifier_percentage");
	}

	public boolean getDoNonToolSpeedModification () {
		return configData.getBoolean("do_non_tool_speed_modification");
	}
	...
	private NbtCompound getDefaults () {
		...
		defaultConfig.putInt("tool_speed_modifier_percentage", 125);
		//defaultConfig.putBoolean("do_non_tool_speed_modification", false);
	...
	private JsonObject toJson (NbtCompound tag) {
		...
		json.addProperty("tool_speed_modifier_percentage", getIntOrDefault(tag, "tool_speed_modifier_percentage", defaults));
		//json.addProperty("do_non_tool_speed_modification", getBooleanOrDefault(tag, "do_non_tool_speed_modification", defaults));
	...
	private NbtCompound toNbtCompound (JsonObject json) {
		...
		tag.putInt("tool_speed_modifier_percentage", getIntOrDefault(json, "tool_speed_modifier_percentage", defaults));
		//tag.putBoolean("do_non_tool_speed_modification", getBooleanOrDefault(json, "do_non_tool_speed_modification", defaults));
